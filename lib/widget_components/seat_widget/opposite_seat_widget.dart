...
class _OppositeSeatWidgetState extends State<OppositeSeatWidget> {
  ...
  bool shouldHighlightSeat() {
    ...
    bool isSeatIndexMatched =
        widget.searchBarText == widget.seatIndex.toString();
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: _handleTap,
      child: OppSeatViewWidget(shouldHighlight: shouldHighlight, widget: widget),
    );
  }
}

class OppSeatViewWidget extends StatelessWidget {
  const OppSeatViewWidget({
    super.key,
  ...
  final OppositeSeatWidget widget;
